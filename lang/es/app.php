...
return [
    ...
    'finish_trip_no_store_confirm' => 'No store selected — finish trip anyway? Setting a store first lets the catalog learn your preferred-store hints and feeds the price history.',
    ...
    'increase_quantity' => 'Aumentar cantidad de :name',
    'decrease_quantity' => 'Disminuir cantidad de :name',
    'add_item' => 'Add item',
    'start_voice_input' => 'Dictate item with your voice',
    'set_price' => 'Set price for :name',
    'mark_preferred_store' => 'Siempre en :store',
    'preferred_store' => 'Tienda habitual',
