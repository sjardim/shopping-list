...
/**
 * Brazilian version of the shopping history seeder. Mirrors the structure
 * of ShoppingHistorySeeder but rotates Brazilian stores and uses BR-portuguese
 * ad-hoc items. Pairs with CatalogItemSeederBr.
 *
 * Run with: php artisan db:seed --class=ShoppingHistorySeederBr
 */
class ShoppingHistorySeederBr extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($catalog->isEmpty()) {
            $this->command->warn('Catalog is empty — run CatalogItemSeederBr first.');
    ...
    /**
     * Trips spread across the past ~60 days, covering all five Brazilian stores.
     *
