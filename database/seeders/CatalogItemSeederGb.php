...
class CatalogItemSeederGb extends Seeder
{
    public function run(): void
    {
        $items = [
            ...
            ['name' => 'Sausages', 'emoji' => '🌭', 'category' => 'carne', 'preferred_store' => 'morrisons', 'default_unit' => 'pacote', 'default_quantity' => 1],
            ...
            ['name' => 'Tinned tuna', 'emoji' => '🐟', 'category' => 'peixe', 'preferred_store' => 'tesco', 'default_unit' => 'lata', 'default_quantity' => 3],
            ['name' => 'Prawns', 'emoji' => '🦐', 'category' => 'peixe', 'preferred_store' => 'waitrose', 'default_unit' => 'g', 'default_quantity' => 300],
            ['name' => 'Sardines', 'emoji' => '🐟', 'category' => 'peixe', 'preferred_store' => 'tesco', 'default_unit' => 'lata', 'default_quantity' => 2],
            ...
            ['name' => 'Crumpets', 'emoji' => '🥯', 'category' => 'padaria', 'preferred_store' => 'tesco', 'default_unit' => 'pacote', 'default_quantity' => 1],
            ['name' => 'Croissant', 'emoji' => '🥐', 'category' => 'padaria', 'preferred_store' => 'waitrose', 'default_unit' => 'un', 'default_quantity' => 4],
            ['name' => 'Crackers', 'emoji' => '🍘', 'category' => 'padaria', 'preferred_store' => 'sainsburys', 'default_unit' => 'pacote', 'default_quantity' => 1],
            ['name' => 'Pitta bread', 'emoji' => '🫓', 'category' => 'padaria', 'preferred_store' => 'morrisons', 'default_unit' => 'pacote', 'default_quantity' => 1],
            ...
            ['name' => 'Tea bags', 'emoji' => '🫖', 'category' => 'bebidas', 'preferred_store' => 'tesco', 'default_unit' => 'pacote', 'default_quantity' => 1],
            ...
            ['name' => 'Biscuits', 'emoji' => '🍪', 'category' => 'despensa', 'preferred_store' => 'sainsburys', 'default_unit' => 'pacote', 'default_quantity' => 1],
            ['name' => 'Baked beans', 'emoji' => '🫘', 'category' => 'despensa', 'preferred_store' => 'asda', 'default_unit' => 'lata', 'default_quantity' => 4],
            ['name' => 'Chickpeas', 'emoji' => '🫘', 'category' => 'despensa', 'preferred_store' => 'asda', 'default_unit' => 'lata', 'default_quantity' => 2],
            ...
            ['name' => 'Bin bags', 'emoji' => '🗑️', 'category' => 'limpeza', 'preferred_store' => 'sainsburys', 'default_unit' => 'rolo', 'default_quantity' => 1],
            ...
            ['name' => 'Sanitary pads', 'emoji' => '🩸', 'category' => 'higiene', 'preferred_store' => 'sainsburys', 'default_unit' => 'pacote', 'default_quantity' => 1],
        ];
